...
echo ""
echo "下一步：執行 02b_image_metadata.md 為圖片建立描述檔"
```
...
- [02b_image_metadata.md](./02b_image_metadata.md) - 圖片描述檔生成
- [03_content_flow.md](./03_content_flow.md) - 圖文排序整合
