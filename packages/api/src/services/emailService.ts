...
function getContactEmail(): string {
  return process.env.CONTACT_EMAIL || 'sales@ewill.com.tw';
}

function getFromEmail(): string {
  return process.env.FROM_EMAIL || 'noreply@ewill.com.tw';
}
...
function generateEmailHtml(
  ...
  const sourcePage = submission.source_page
    ? escapeHtml(submission.source_page)
    : '未知';
